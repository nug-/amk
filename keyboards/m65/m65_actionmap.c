...
const action_t actionmaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_default(
        ...
        AC_TAB,     AC_Q,     AC_W, AC_E, AC_R, AC_T, AC_Y, AC_U,    AC_I,   AC_O,    AC_P, AC_LBRC, AC_RBRC, AC_BSPS,
        AC_LCAPS,   AC_A,     AC_S, AC_D, AC_F, AC_G, AC_H, AC_J,    AC_K,   AC_L, AC_SCLN, AC_QUOT,           AC_ENT, AC_INS,
        AC_LSFT,    AC_Z,     AC_X, AC_C, AC_V, AC_B, AC_N, AC_M, AC_COMM, AC_DOT, AC_SLSH,          AC_RSFT,   AC_UP,  AC_DEL,
